...
import com.fjr619.core.domain.model.Gender
import com.fjr619.core.domain.model.GoalType
import com.fjr619.core.domain.model.UserInfo
import com.fjr619.core.domain.preferences.Preferences
import com.fjr619.tracker_domain.model.MealType
...
class CalculateMealNutrients(
    ...
    operator fun invoke(
        ...
        val carbsGoal = (caloryGoal * userInfo.carbRatio / 4f).roundToInt() // 1gr carbs = 4cal
        val proteinGoal = (caloryGoal * userInfo.proteinRatio / 4f).roundToInt() // 1gr carbs = 4cal
        val fatGoal = (caloryGoal * userInfo.fatRatio / 9f).roundToInt() // 1gr carbs = 9cal
